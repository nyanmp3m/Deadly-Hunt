...
from Sprites_classes.Ghost import GHOST
...
class MainMenu(arcade.View):
    ...
    def on_draw(self):
        ...
        elif background == "background2.jpg":
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        for sprite in ghost_hits:
            if not sprite.disappearing and not sprite.disappeared and not sprite.appearing and sprite.cooldown >= 0.5:
